...
RSpec.describe Qo::Branches::MonadicElseBranch do
  let(:destructure)  { false }

  let(:branch) {
    Qo::Branches::MonadicElseBranch.new(destructure: destructure)
  }

  describe '.initialize' do
    it 'can be initialized' do
      expect(branch).to be_a(Qo::Branches::MonadicElseBranch)
    end
  end
